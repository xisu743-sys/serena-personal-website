(function () {
  ...
  const copy = {
    ...
    '一个不太松弛的中文系女生': 'A Chinese-literature girl\nstill learning to loosen up',
    '无意中看到Agent橘的CC小白教程': 'A chance encounter with\nAgent Orange’s CC primer',
    '自此打开AI世界的大门': 'opened the door to\nthe world of AI.',
    ...
    '梦想是成为会说十门语言的cool girl': 'Dreaming of becoming\na cool girl who speaks ten languages',
    '于是法语、德语、日语、韩语都学了点': 'So I have dipped into\nFrench, German,\nJapanese, and Korean.',
    '都没去考级 好在雅思7.0 勉强过关': 'No certificates—but an IELTS 7.0\ngets me through.',
    '写过公众号，做过央视微纪录片': 'I have written for WeChat\nand made a CCTV micro-documentary.',
    '和抖音博主稳定合作两年': 'I partnered steadily\nwith a Douyin creator for two years.',
    '在重卡自动驾驶行业干过pr': 'I have also worked in PR\nfor autonomous heavy trucks.',
