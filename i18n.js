(function () {
  ...
  const copy = {
    ...
    '查看全部拾记 →': 'All Finds →',
    '查看全部随记 →': 'All Notes →',
    '← 返回存在体概况': '← Back to Entity Profile',
    '拾记与随记': 'Finds and Notes',
    '第一篇文章正在整理中': 'The first article is taking shape',
    '下一篇文章正在整理中': 'The next article is taking shape',
    '这里会记录那些值得马上转发给朋友的工具、网页和意外发现。': 'This is where I will collect tools, websites, and unexpected finds worth sending straight to a friend.',
    '这里会记录实习、工作和生活里，那些暂时还没有答案的片段。': 'This is where I will collect fragments from internships, work, and life that do not have answers yet.',
    '新的文章会从这里开始，按时间慢慢展开。': 'New articles will unfold here, one at a time.',
    '第二篇文章会从这里开始，内容和它的配图保持连续出现。': 'The second article will continue here, with its image directly after the text.',
    '配图占位：之后可以替换成这篇文章的图片。': 'Image placeholder: replace this with the article image later.',
    '上一张配图': 'Previous image',
    '下一张配图': 'Next image',
    'Finds 第一篇文章配图': 'Finds image carousel, article one',
    'Finds 第二篇文章配图': 'Finds image carousel, article two',
    'Notes 第一篇文章配图': 'Notes image carousel, article one',
    'Notes 第二篇文章配图': 'Notes image carousel, article two',
    '漂流瓶插画': 'Message bottle illustration',
    '贝壳插画': 'Seashell illustration',
